...
void main() {
  ...
  test('reports declarations, references, part ownership, and generated files', () async {
    final result = await Process.run(Platform.resolvedExecutable, [
      'run',
      'bin/probe.dart',
      'fixture',
    ...
    expect(report['files'], 9);
    expect(report['declarations'], 12);
    expect(report['references'], 7);
    ...
    expect(report['declarationIds'], [
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions.dart#22>',
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions.dart#22>.markerOne',
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions.dart#69>',
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions.dart#69>.markerTwo',
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions_two.dart#22>',
      'package:phase0_fixture/main.dart::<unnamed-extension@package:phase0_fixture/extensions_two.dart#22>.markerThree',
