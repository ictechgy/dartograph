...
- `docs/PLAN.md` 의 공개 Flutter 프로젝트 3 개에서 돌아가고, 미사용 보고 상위 10 건 손 검증 오탐 0
...
| | `dart analyze` | DCM 무료 | DCM 유료 | dartograph |
|---|---|---|---|---|
...
| CI 에 라이선스 키 | 불필요 | 필요 | 필요 | **불필요** |
| 상업적 사용 | 무료 | 제한 | 유료 | **영구 무료** |

DCM 열의 사실은 게시 전에 dcm.dev 에서 다시 확인한다.
